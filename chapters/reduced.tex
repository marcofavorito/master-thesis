...
%TODO: assume MDP or not?
% and a real-valued reward $R$ given for the transition $s \to^a s'$. 
%Notice that we do not assume nothing about the transition function $\TrFun$, i.e. in this case, the law that determines  the possible next state given a trajectory.
...
%TODO depends on MDP assumption of above
...
\subsection{An episodic goal-based view}
